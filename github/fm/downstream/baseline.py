...
class Baseline(nn.Module):
    def __init__(self,
        ...
        self.model_location = model_location # 读取已经保存的权重
        ...
        # 1.Build backbone
        self.backbone, self.backbone_alphabet = choose_backbone(self.backbone_name, model_location=self.model_location)    
        ...
        for key in self.downstream_modules.keys():
            ...
            self.downstream_modules[key].apply(weights_init_classifier)   # 最优 reduction 这块还挺重要的
